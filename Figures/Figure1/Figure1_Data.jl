...
data = runtimes(CSV.read("./Figures/Figure1/results_sites.csv",DataFrame))
CSV.write("./Figures/Figure1/rollout_results_sites.csv",data)
...
CSV.write("./Figures/Figure1/Cutfree_interaction_data.csv",intdata)
data = runtimes(CSV.read("./Figures/Figure1/results_length.csv",DataFrame))
CSV.write("./Figures/Figure1/rollout_results_length.csv",data)
