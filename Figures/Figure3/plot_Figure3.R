...
plot_panelsCDEF <- function(infile1,infile2,infile3,infile4,BF_poolsize=453,BF_pct_genes_hit=100, BF_total_hits=412260, BF_interuniformity_score=.337,BF_intrauniformity_score=0.237){
  ##Data1
...
plot_panelsGH <- function(infile1,infile2){
  font_size=8
  font="Arial"
  line_size=.4
  point_size=0.6
...
plot_NSR_figure <- function(outfile){
  ...
  genome_bench_file <- "All_species_benchmark.csv" 
  poolsize_bench_file <- "Intrauniformity_timing_benchmark_cumulative.csv"
  infile1 <-"S_mutans_benchmark_cumulative.csv"
  infile2 <-"S_mutans_benchmark_cumulative.csv"
  infile3 <-"S_mutans_benchmark_cumulative.csv"
  infile4 <-"S_mutans_benchmark_cumulative.csv"
  row1 <- plot_panelsCDEF(infile1,infile2,infile3,infile4)
  row2 <- plot_panelsGH(genome_bench_file,poolsize_bench_file)
